...
# MAGIC
# MAGIC **Your DLT Pipeline is ready!** Your pipeline was started using the SQL notebook and is <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/d1ed0df7-d84e-41ed-9eea-ec003b89fa92">available here</a>.
# MAGIC
# MAGIC <!-- Collect usage data (view). Remove it to disable collection. View README for more details.  -->
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=3140274369437577&notebook=%2F02-DLT-Loan-pipeline-PYTHON&demo_name=dlt-loans&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fdlt-loans%2F02-DLT-Loan-pipeline-PYTHON&version=1">
...
dbutils.fs.ls('/Volumes/dev_bronze/dbdemos_dlt_loan/raw_data/raw_transactions')
...
def raw_txs():
    return (
        ...
        .load("/Volumes/dev_bronze/dbdemos_dlt_loan/raw_data/raw_transactions")
    )
...
def ref_accounting_treatment():
    return spark.read.format("delta").load(
        "/Volumes/dev_bronze/dbdemos_dlt_loan/raw_data/ref_accounting_treatment"
    )
...
def raw_historical_loans():
    return (
        ...
        .option("cloudFiles.inferColumnTypes", "true")
        .load("/Volumes/dev_bronze/dbdemos_dlt_loan/raw_data/historical_loans")
    )
...
# MAGIC %md ## Next steps
# MAGIC
# MAGIC Your DLT pipeline is ready to be started. <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/d1ed0df7-d84e-41ed-9eea-ec003b89fa92">Click here to access the pipeline</a> created for you using the SQL notebook.
# MAGIC
