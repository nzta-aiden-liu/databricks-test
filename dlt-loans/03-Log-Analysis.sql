...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=3140274369437577&notebook=%2F03-Log-Analysis&demo_name=dlt-loans&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fdlt-loans%2F03-Log-Analysis&version=1">

-- COMMAND ----------

SELECT * FROM dev_bronze.dbdemos_dlt_loan.event_logs
...
--   as SELECT * FROM event_log(TABLE(dev_bronze.dbdemos_dlt_loan.raw_txs));
...
FROM dev_bronze.dbdemos_dlt_loan.event_logs
...
from
  dev_bronze.dbdemos_dlt_loan.event_logs e,
...
-- MAGIC %md
-- MAGIC Your expectations are ready to be queried in SQL! Open the <a dbdemos-dashboard-id="dlt-expectations" href='/sql/dashboardsv3/01f0473132e31302b37b83e78022c167' target="_blank">data Quality Dashboard example</a> for more details.